# Generated by Django 2.1.7 on 2019-10-29 12:50
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('导入excel', models.FileField(upload_to='excel/', verbose_name='导入Excel')),
            ],
        ),
        migrations.CreateModel(
            name='Instrument',
        ...
        migrations.AddField(
            model_name='myuser',
            name='belong_lab',
            field=models.ManyToManyField(blank=True, related_name='belongLab', to='user.Lab', verbose_name='所属实验室'),
        ),
        migrations.AddField(
            model_name='myuser',
            name='groups',
