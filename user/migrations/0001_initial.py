    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('statu', models.SmallIntegerField(choices=[(1, '通过'), (-1, '未通过'), (0, '未处理'), (2, '已归还')], default=0, verbose_name='状态')),
                ('name', models.CharField(default='无', max_length=10, verbose_name='申请人姓名')),
                ('openId', models.CharField(default='None', max_length=32, verbose_name='用户微信的openId')),
                ('formId', models.CharField(default='无', max_length=50, verbose_name='表单id')),
            ],
            options={
                'verbose_name': '申请',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('jscode', models.CharField(max_length=50, verbose_name='jscode')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='', max_length=500, verbose_name='仪器名称')),
                ('model_number', models.CharField(default='', max_length=500, verbose_name='仪器编号')),
                ('model_type', models.CharField(default='', max_length=200, verbose_name='仪器型号')),
                ('maker', models.CharField(default='', max_length=500, verbose_name='厂家')),
                ('type', models.CharField(default='', max_length=500, verbose_name='类别')),
                ('is_lend', models.BooleanField(default=False, verbose_name='是否出借')),
                ('describe', models.CharField(default='', max_length=500, verbose_name='仪器描述')),
            ],
            options={
                'verbose_name': '实验仪器',
