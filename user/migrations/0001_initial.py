    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Instrument_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.Instrument', verbose_name='仪器')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('belong_lab', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='belongLab', to='user.Lab', verbose_name='所属实验室')),
